...
> Generated by `@oracle/bots-node-sdk` on **Mon Aug 12 2019**
...
curl -H "Content-Type: application/json" -d @./spec/test.req.json localhost:3000/components/CurrencyConverter
```
